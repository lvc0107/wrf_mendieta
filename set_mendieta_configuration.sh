...
export WRF_DIR=$WRF_BASE/WRFV3              # Directorio principal de WRF
export WPS_DIR=$WRF_BASE/WPS                # Directorio principal del pre-procesador WPS
export ARWPOST_DIR=$WRF_BASE/ARWpost        # Directorio principal del post-procesador ARWPost
